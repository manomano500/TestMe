...
<div id="rg">
 ...
 <!--// moved from signup form   -->
    ...
    <label class="frgrmb" for="rmbr" style="display: inline">
        Remeber Me</label
    >
    <a style="font-size: small" href="#">Forget password?</a>
    
    <!-- <button class="lgbtn">Login</button> -->
    <!--login btn-->
    
    <input name="submit" type="submit" class="signn" value="Login" ><br> <!--//    onclick="submitValue()"   moved from signup form   -->
...
<div id="rgn">
   ...
   <!--  <label for="name">Name: </label>
    ...
    <input name="submit" type="submit" class="signn" value="Signup"><!--  onclick="submitValue() -->
...
<table class="divy">
    <tr>
    <td colspan="2">
        <span class="About">About</span><span class="us">us</span
        ><br /><br /><br />
        <div class="container_row">
        <div class="layer1" id="content">
            <span class="f">Our </span
            ><span class="txt"
            >goal is to create English language prof
            iency <br />tests that
            are not only accurate, but also accessible, <br />easy to use,
            and available at all times.</span
            >
        </div>
        <div class="layer2">
            <br /><span class="f">Our</span
            ><span class="txt2">
            team : Mohamed Tekar , Fatima Alomrany , Mahjouba</span
            >
        </div>
        <br /><br />
        </div>
